...
export function UploadWidget() {
	...
	const [expiration, setExpiration] = useState<UploadExpiration>(
		UploadExpiration.ONE_HOUR,
	);
	const [customExpiration, setCustomExpiration] = useState<number>(
		new Date().getTime(),
	);
		...
		<div className="upload-widget">
			...
			<div className="upload-widget-container">
				<div className="file-info">
					...
					<span className="file-info-line file-type">
						{fileInfo.type || "File Type"}
					</span>
					<span className="file-info-line file-size">
						{fileInfo.size ? formatBytes(fileInfo.size) : "File Size"}
					</span>
					<Button
				...
				<div className="upload-options">
					<div className="upload-option-group upload-method">
						...
						<ChipsSelect<UploadMethod>
							...
							onChange={(selected) =>
								handleUploadMethodChange(selected[0] as UploadMethod)
							}
						/>
					</div>
					...
					<div className="upload-option-group upload-expiration">
						...
						<ChipsSelect<UploadExpiration>
							options={[
								...
								{
									label: `${
										expiration === UploadExpiration.CUSTOM
							...
							value={expiration}
							onChange={(selected) =>
								handleExpirationChange(selected[0] as UploadExpiration)
							}
						/>
					</div>
