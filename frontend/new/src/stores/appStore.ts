  ...
  modules: [
    {
      name: "Upload",
      apiRoutes: new Map([
        ["UPLOAD_REQUEST", "/api/upload/request"],
        ["UPLOAD_STATUS", "/api/upload_status/<uuid>"],
        ["UPLOAD_ENTIRE", "/api/upload/<uuid>"],
        ["UPLOAD_PART", "/api/upload/part/<uuid>/<part_number>"],
      ]),
      version: "0.2.0",
    ...
    },
    {
      ...
      apiRoutes: new Map([
        ["YOUTUBE_REQUEST", "/api/youtube/request"],
        ["YOUTUBE_DOWNLOAD", "/api/youtube/download/<uuid>"],
      ]),
      version: "0.2.0",
